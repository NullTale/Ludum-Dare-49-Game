...
public static class DirectionHelper
{
	...
	public static readonly Vector2Int k_Vec2IntLeft = new Vector2Int(-1, 0);
	public static readonly Vector2Int k_Vec2IntRight = new Vector2Int(1, 0);
	public static readonly Vector2Int k_Vec2IntTop = new Vector2Int(0, 1);
	public static readonly Vector2Int k_Vec2IntBottom = new Vector2Int(0, -1);

	public static readonly Vector2Int k_Vec2IntLeftTop = new Vector2Int(-1, 1);
	public static readonly Vector2Int k_Vec2IntLeftBottom = new Vector2Int(-1, -1);
	public static readonly Vector2Int k_Vec2IntRightTop = new Vector2Int(1, 1);
	public static readonly Vector2Int k_Vec2IntRightBottom = new Vector2Int(1, -1);
    
	public static readonly Vector2      k_Vector2Center = new Vector2(0.5f, 0.5f);
    public static readonly Vector2		k_Vector2LeftTop     = new Vector2(-0.707106769084930419921875f, 0.707106769084930419921875f);
    public static readonly Vector2		k_Vector2RightTop    = new Vector2(0.707106769084930419921875f, 0.707106769084930419921875f);
    public static readonly Vector2		k_Vector2LeftBottom  = new Vector2(-0.707106769084930419921875f, -0.707106769084930419921875f);
    public static readonly Vector2		k_Vector2RightBottom = new Vector2(0.707106769084930419921875f, -0.707106769084930419921875f);

    public static readonly Vector3		k_Vector3LeftTop     = new Vector3(-0.707106769084930419921875f, 0.0f, 0.707106769084930419921875f);
    public static readonly Vector3		k_Vector3RightTop    = new Vector3(0.707106769084930419921875f, 0.0f, 0.707106769084930419921875f);
    public static readonly Vector3		k_Vector3LeftBottom  = new Vector3(-0.707106769084930419921875f, 0.0f, -0.707106769084930419921875f);
    public static readonly Vector3		k_Vector3RightBottom = new Vector3(0.707106769084930419921875f, 0.0f, -0.707106769084930419921875f);
	...
	{
		new AngleDirection() {Min = 45.0f, Max = 135.0f, Direction = Direction.Top},
		new AngleDirection() {Min = -135.0f, Max = -45.0f, Direction = Direction.Bottom},

		new AngleDirection() {Min = 0.0f, Max = 45.0f, Direction = Direction.Right},
		new AngleDirection() {Min = -45.0f, Max = 0.0f, Direction = Direction.Right},

		new AngleDirection() {Min = 135.0f, Max = 180.0f, Direction = Direction.Left},
		new AngleDirection() {Min = -180.0f, Max = -135.0f, Direction = Direction.Left},
	};

	public static readonly List<AngleDirection> g_DirectionRange8Dim = new List<AngleDirection>()
	{
		new AngleDirection() {Min = 67.5f, Max = 112.5f, Direction = Direction.Top},
		new AngleDirection() {Min = -112.5f, Max = -67.5f, Direction = Direction.Bottom},

		new AngleDirection() {Min = 22.5f, Max = 67.5f, Direction = Direction.RightTop},
		new AngleDirection() {Min = -67.5f, Max = -22.5f, Direction = Direction.RightBottom},

		new AngleDirection() {Min = 112.5f, Max = 157.5f, Direction = Direction.LeftTop},
		new AngleDirection() {Min = -157.5f, Max = -112.5f, Direction = Direction.LeftBottom},

		new AngleDirection() {Min = 0.0f, Max = 22.5f, Direction = Direction.Right},
		new AngleDirection() {Min = -22.5f, Max = 0.0f, Direction = Direction.Right},

		new AngleDirection() {Min = 157.5f, Max = 180.0f, Direction = Direction.Left},
		new AngleDirection() {Min = -180.0f, Max = -157.5f, Direction = Direction.Left}
	};
