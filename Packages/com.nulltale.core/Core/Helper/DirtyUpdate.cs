    ...
    public class DirtyUpdate
    {
        ...
        { 
            ...
            switch (dirty)
            {
                // delayed update
                case Dirty.Update:
                    m_UpdateCoroutine = global::CoreLib.Core.Instance.StartCoroutine(_CleanUpdate(updateAction));
                    break;
                case Dirty.FixedUpdate:
                    m_UpdateCoroutine = global::CoreLib.Core.Instance.StartCoroutine(_CleanFixedUpdate(updateAction));
                    break;
                case Dirty.ImmediateUpdate:
                    m_UpdateCoroutine = global::CoreLib.Core.Instance.StartCoroutine(_CleanImmediate(updateAction));
                    break;
        ...
        private void _CancelUpdate()
        {
            ...
            {
                global::CoreLib.Core.Instance.StopCoroutine(m_UpdateCoroutine);
                m_UpdateCoroutine = null;
            }
        }
    }
