    ...
    public class AstarTest : MonoBehaviour
    {
        ...
        public void SpeedTest()
        {
            ...
            for (var n = 0; n < Calls; n++)
                Explorer.FindPath(Options, null, Grid[From], Grid[To]).Implement();
            sw.Stop();
        ...
        public void FindPath()
        {
            ...
            sw.Start();
            FindPathProcess = Explorer.FindPath(Options, null, Grid[From], Grid[To]).Implement();
            sw.Stop();
